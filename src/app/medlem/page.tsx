...
export default function MemberPage() {
  return (
    <div className="container mx-auto p-12">
      ...
      <h2 className="text-2xl font-bold p-4">Medlemskap og Avgifter</h2>
      <p className="p-4">
      ...
      <h2 className="text-2xl font-bold p-4">Tilbud om Betalingsfritak</h2>
      <p className="p-4">
      ...
      <h2 className="text-2xl font-bold p-4">Kontakt</h2>
      <p className="p-4">
